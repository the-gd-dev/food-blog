    ...
    <div className="flex justify-center items-center h-dvh flex-col bg-center bg-cover bg-[url(https://cdn.wallpapersafari.com/22/18/riY3Ba.jpg)]">
      ...
      <div>
        <ul className="flex gap-3">
          <li>
            <Link className="bg-white p-2 rounded-sm hover:bg-zinc-100 transition-all" href={"/blog"}>
              Blog
            </Link>
          </li>
          <li>
            <Link className="bg-white p-2 rounded-sm hover:bg-zinc-100 transition-all" href={"/"}>
              Terms Of Use
            </Link>
          </li>
          <li>

...
const variants: { [key in NonNullable<ButtonProps["variant"]>]: string } = {
  none: ``,
  primary: `p-2.5 shadow-sm bg-amber-500 text-white hover:bg-amber-600 active:bg-amber-700 focus-visible:ring-amber-500`,
  secondary: `p-2.5 shadow-sm bg-gray-100 text-gray-800 hover:bg-gray-200 active:bg-gray-300 focus-visible:ring-gray-400`,
  danger: `p-2.5 shadow-sm bg-red-500 text-white hover:bg-red-600 active:bg-red-700 focus-visible:ring-red-500`,
  outline: `p-2.5 shadow-sm border border-gray-300 bg-transparent text-gray-800 hover:bg-gray-100 active:bg-gray-200 focus-visible:ring-gray-400`,
};
